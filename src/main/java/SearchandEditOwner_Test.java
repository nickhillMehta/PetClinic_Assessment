...
public class SearchandEditOwner_Test {
    ...
    public void SearchandEditOwnerTest(String firstname, String lastname, String address, String city, String phonenumber, int expectedResult, String browser, String Url) {
        ...
        try {
            ...
            editandDisplayUserDetails.clickEditOwner();
            Reporter.log("--Clicking Edit Owner Button::");
            addOwnerInfo.editFname(firstname);
            Reporter.log("--Setting Firstname in firstname textbox::");
            addOwnerInfo.editLname(lastname);
            Reporter.log("--Setting Lastname in lasttname textbox::");
            addOwnerInfo.editAddress(address);
            Reporter.log("--Setting Address in address textbox::");
            addOwnerInfo.editCity(city);
            Reporter.log("--Setting City in city textbox::");
            addOwnerInfo.editPhone(phonenumber);
            ...
            if (addOwnerInfo.isRedCrossPresent() && addOwnerInfo.isValidationErrPresent()) {
                ...
                editandDisplayUserDetails.verify_details(firstname + " " + lastname, address, city, phonenumber);
    ...
    public Object[][] dataProviderMethod() {
        ...
        return new Object[][]{{"Jeff", "Black", "1450 Oak Blvd", "Monona" + ch_date, "6085555387", 1, "Chrome", "http://localhost:8080/owners/find"}, {"Jeff", "Black", "1450 Oak Blvd", "Monona" + ch_date, "6085555387999", 0, "Chrome", "http://localhost:8080/owners/find"}};
    }
